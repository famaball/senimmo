                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'date'">{{ trans('admin.reservation.columns.date') }}</th>
                                        <th is='sortable' :column="'etat'">{{ trans('admin.reservation.columns.etat') }}</th>
                                        <th is='sortable' :column="'description'">{{ trans('admin.reservation.columns.description') }}</th>
                                        <th is='sortable' :column="'prenom'">{{ trans('admin.reservation.columns.prenom') }}</th>
                                        <th is='sortable' :column="'nom'">{{ trans('admin.reservation.columns.nom') }}</th>
                                        <th is='sortable' :column="'telephone'">{{ trans('admin.reservation.columns.telephone') }}</th>
                                        <th is='sortable' :column="'email'">{{ trans('admin.reservation.columns.email') }}</th>
                                        <th is='sortable' :column="'adresse'">{{ trans('admin.reservation.columns.adresse') }}</th>
