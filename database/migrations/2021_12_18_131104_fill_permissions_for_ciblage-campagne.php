...
class FillPermissionsForCiblageCampagne extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCiblageCampagne constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ciblage-campagne',
            'admin.ciblage-campagne.index',
            'admin.ciblage-campagne.create',
            'admin.ciblage-campagne.show',
            'admin.ciblage-campagne.edit',
            'admin.ciblage-campagne.delete',
            'admin.ciblage-campagne.bulk-delete',
        ]);
