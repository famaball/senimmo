...
class FillPermissionsForCiblage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCiblage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ciblage',
            'admin.ciblage.index',
            'admin.ciblage.create',
            'admin.ciblage.show',
            'admin.ciblage.edit',
            'admin.ciblage.delete',
            'admin.ciblage.bulk-delete',
        ]);
