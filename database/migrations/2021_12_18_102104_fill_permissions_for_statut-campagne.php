...
class FillPermissionsForStatutCampagne extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStatutCampagne constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.statut-campagne',
            'admin.statut-campagne.index',
            'admin.statut-campagne.create',
            'admin.statut-campagne.show',
            'admin.statut-campagne.edit',
            'admin.statut-campagne.delete',
            'admin.statut-campagne.bulk-delete',
        ]);
