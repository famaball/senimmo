...
class FillPermissionsForTypeBien extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeBien constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-bien',
            'admin.type-bien.index',
            'admin.type-bien.create',
            'admin.type-bien.show',
            'admin.type-bien.edit',
            'admin.type-bien.delete',
            'admin.type-bien.bulk-delete',
        ]);
