...
class FillPermissionsForStatutBien extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStatutBien constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.statut-bien',
            'admin.statut-bien.index',
            'admin.statut-bien.create',
            'admin.statut-bien.show',
            'admin.statut-bien.edit',
            'admin.statut-bien.delete',
            'admin.statut-bien.bulk-delete',
        ]);
