...
class FillPermissionsForCampagne extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCampagne constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.campagne',
            'admin.campagne.index',
            'admin.campagne.create',
            'admin.campagne.show',
            'admin.campagne.edit',
            'admin.campagne.delete',
            'admin.campagne.bulk-delete',
        ]);
