...
class FillPermissionsForTypeCampagne extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeCampagne constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-campagne',
            'admin.type-campagne.index',
            'admin.type-campagne.create',
            'admin.type-campagne.show',
            'admin.type-campagne.edit',
            'admin.type-campagne.delete',
            'admin.type-campagne.bulk-delete',
        ]);
