...
class FillPermissionsForEtatBien extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEtatBien constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.etat-bien',
            'admin.etat-bien.index',
            'admin.etat-bien.create',
            'admin.etat-bien.show',
            'admin.etat-bien.edit',
            'admin.etat-bien.delete',
            'admin.etat-bien.bulk-delete',
        ]);
