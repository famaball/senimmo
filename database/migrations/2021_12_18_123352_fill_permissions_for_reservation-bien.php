...
class FillPermissionsForReservationBien extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReservationBien constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.reservation-bien',
            'admin.reservation-bien.index',
            'admin.reservation-bien.create',
            'admin.reservation-bien.show',
            'admin.reservation-bien.edit',
            'admin.reservation-bien.delete',
            'admin.reservation-bien.bulk-delete',
        ]);
