...
class FillPermissionsForContactCampagne extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContactCampagne constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contact-campagne',
            'admin.contact-campagne.index',
            'admin.contact-campagne.create',
            'admin.contact-campagne.show',
            'admin.contact-campagne.edit',
            'admin.contact-campagne.delete',
            'admin.contact-campagne.bulk-delete',
        ]);
