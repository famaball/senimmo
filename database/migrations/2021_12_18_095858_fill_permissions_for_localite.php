...
class FillPermissionsForLocalite extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLocalite constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.localite',
            'admin.localite.index',
            'admin.localite.create',
            'admin.localite.show',
            'admin.localite.edit',
            'admin.localite.delete',
            'admin.localite.bulk-delete',
        ]);
