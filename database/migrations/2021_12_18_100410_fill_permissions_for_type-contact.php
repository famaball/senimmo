...
class FillPermissionsForTypeContact extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeContact constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-contact',
            'admin.type-contact.index',
            'admin.type-contact.create',
            'admin.type-contact.show',
            'admin.type-contact.edit',
            'admin.type-contact.delete',
            'admin.type-contact.bulk-delete',
        ]);
